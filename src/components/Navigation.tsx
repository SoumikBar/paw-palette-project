...
const navItems = [
  ...
  { id: "motive", label: "Our Motive" },
  { id: "donate", label: "Donate" },
  { id: "volunteer", label: "Volunteer" },
  { id: "message", label: "Director's Message" },
];
      ...
      >
        <div className="container flex items-center justify-between h-16 px-4 mx-auto md:h-20">
          ...
          >
            ...
            />
            <span className="text-xl font-serif font-medium text-foreground md:text-2xl">
              Feed Paws
            </span>
          </motion.button>
          ...
          <motion.button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg md:hidden bg-muted"
            whileTap={{ scale: 0.9 }}
          >
            {isMobileMenuOpen ? (
              <X className="w-5 h-5" />
