...
const stats = [
  { value: 117, label: "Dogs Fed", suffix: "+" },
  { value: 16, label: "Volunteers", suffix: "" },
  { value: 1, label: "Locations", suffix: "" },
];
        ...
        <div className="container relative z-10 px-4 mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <motion.button
                ...
                className="px-8 py-4 font-medium rounded-full gradient-hero text-primary-foreground shadow-glow"
                whileHover={{ scale: 1.05, boxShadow: "0 12px 50px -8px hsl(24 95% 53% / 0.4)" }}
                whileTap={{ scale: 0.98 }}
              >
                See Our Work
              </motion.button>
              ...
              <motion.button
                onClick={() => onNavigate("motive")}
                className="px-8 py-4 font-medium transition-colors border-2 rounded-full border-primary text-primary hover:bg-primary hover:text-primary-foreground"
          ...
          >
            <div className="w-6 h-10 border-2 rounded-full border-muted-foreground/30">
              <motion.div
                className="w-2 h-2 mx-auto mt-2 rounded-full bg-primary"
                animate={{ y: [0, 16, 0] }}
                transition={{ duration: 2, repeat: Infinity }}
              />
            </div>
            ...
            <div className="relative z-10 text-center">
              ...
              >
                ...
                <motion.button
                  ...
                  className="px-8 py-4 font-medium transition-colors rounded-full bg-card text-foreground hover:bg-card/90"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                >
                  Become a Volunteer
